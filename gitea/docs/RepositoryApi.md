...
async with swagger_client.ApiClient(configuration) as api_client:
    ...
    api_instance = swagger_client.RepositoryApi(api_client)
...
async with swagger_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Create a release attachment
        api_response = await api_instance.repo_create_release_attachment(owner, repo, id, attachment, name=name)
...
async with swagger_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get a list of all commits from a repository
        api_response = await api_instance.repo_get_all_commits(owner, repo, sha=sha, path=path, stat=stat, page=page, limit=limit)
...
async with swagger_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get a note corresponding to a single commit from a repository
        api_response = await api_instance.repo_get_note(owner, repo, sha)
...
async with swagger_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get commits for a pull request
        api_response = await api_instance.repo_get_pull_request_commits(owner, repo, index, page=page, limit=limit)
...
async with swagger_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get a file from a repository
        await api_instance.repo_get_raw_file(owner, repo, filepath, ref=ref)
    except Exception as e:
...
async with swagger_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get a file or it's LFS object from a repository
        await api_instance.repo_get_raw_file_or_lfs(owner, repo, filepath, ref=ref)
    except Exception as e:
...
async with swagger_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get a single commit from a repository
        api_response = await api_instance.repo_get_single_commit(owner, repo, sha)
...
async with swagger_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List a repo's pull requests
        api_response = await api_instance.repo_list_pull_requests(owner, repo, state=state, sort=sort, milestone=milestone, labels=labels, page=page, limit=limit)
...
async with swagger_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List a repo's releases
        api_response = await api_instance.repo_list_releases(owner, repo, draft=draft, pre_release=pre_release, per_page=per_page, page=page, limit=limit)
