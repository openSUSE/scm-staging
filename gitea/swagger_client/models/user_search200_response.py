...
class UserSearch200Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserSearch200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserSearch200Response:
        """Create an instance of UserSearch200Response from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return UserSearch200Response.parse_obj(obj)

        _obj = UserSearch200Response.parse_obj(
            {
