...
class IssueLabelsOption(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IssueLabelsOption:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IssueLabelsOption:
        """Create an instance of IssueLabelsOption from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return IssueLabelsOption.parse_obj(obj)

        _obj = IssueLabelsOption.parse_obj({"labels": obj.get("labels")})
        return _obj
