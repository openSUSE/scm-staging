...
class AddTimeOption(object):
    ...
    """
    swagger_types = {"created": "datetime", "time": "int", "user_name": "str"}

    attribute_map = {"created": "created", "time": "time", "user_name": "user_name"}

    def __init__(
        self, created=None, time=None, user_name=None, _configuration=None
    ):  # noqa: E501
