...
class CreateMilestoneOption(object):
    ...
    def __init__(
        self, description=None, due_on=None, state=None, title=None, _configuration=None
    ):  # noqa: E501
    ...
    def state(self, state):
        ...
        if self._configuration.client_side_validation and state not in allowed_values:
            raise ValueError(
