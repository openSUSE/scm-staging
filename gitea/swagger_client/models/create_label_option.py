...
class CreateLabelOption(object):
    ...
    """
    swagger_types = {"color": "str", "description": "str", "name": "str"}

    attribute_map = {"color": "color", "description": "description", "name": "name"}

    def __init__(
        self, color=None, description=None, name=None, _configuration=None
    ):  # noqa: E501
    ...
    def color(self, color):
        ...
        if self._configuration.client_side_validation and color is None:
            raise ValueError(
                "Invalid value for `color`, must not be `None`"
            )  # noqa: E501
