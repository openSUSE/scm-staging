...
class EditReactionOption(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EditReactionOption:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EditReactionOption:
        """Create an instance of EditReactionOption from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return EditReactionOption.parse_obj(obj)

        _obj = EditReactionOption.parse_obj({"content": obj.get("content")})
        return _obj
