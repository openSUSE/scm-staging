...
class BranchProtection(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BranchProtection:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BranchProtection:
        """Create an instance of BranchProtection from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return BranchProtection.parse_obj(obj)

        _obj = BranchProtection.parse_obj(
            {
                ...
                "block_on_official_review_requests": obj.get(
                    "block_on_official_review_requests"
                ),
