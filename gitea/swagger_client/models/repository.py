        ...
        _obj = Repository.parse_obj(
            {
                ...
                "owner": User.from_dict(obj.get("owner"))
                if obj.get("owner") is not None
                else None,
                "parent": Repository.from_dict(obj.get("parent"))
                if obj.get("parent") is not None
                else None,
                "permissions": Permission.from_dict(obj.get("permissions"))
                if obj.get("permissions") is not None
                else None,
                "private": obj.get("private"),
                "release_counter": obj.get("release_counter"),
                "repo_transfer": RepoTransfer.from_dict(obj.get("repo_transfer"))
                if obj.get("repo_transfer") is not None
                else None,
                "size": obj.get("size"),
