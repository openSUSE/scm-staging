...
class NodeInfoUsageUsers(BaseModel):
    ...
    __properties = ["activeHalfyear", "activeMonth", "total"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NodeInfoUsageUsers:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NodeInfoUsageUsers:
        """Create an instance of NodeInfoUsageUsers from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return NodeInfoUsageUsers.parse_obj(obj)

        _obj = NodeInfoUsageUsers.parse_obj(
            {
                "active_halfyear": obj.get("activeHalfyear"),
                "active_month": obj.get("activeMonth"),
                "total": obj.get("total"),
            }
        )
        return _obj
