...
class MigrateRepoOptions(object):
    ...
    def clone_addr(self, clone_addr):
        ...
        if self._configuration.client_side_validation and clone_addr is None:
            raise ValueError(
                "Invalid value for `clone_addr`, must not be `None`"
            )  # noqa: E501
    ...
    def repo_name(self, repo_name):
        ...
        if self._configuration.client_side_validation and repo_name is None:
            raise ValueError(
                "Invalid value for `repo_name`, must not be `None`"
            )  # noqa: E501
    ...
    def service(self, service):
        ...
        if self._configuration.client_side_validation and service not in allowed_values:
            raise ValueError(
                "Invalid value for `service` ({0}), must be one of {1}".format(  # noqa: E501
