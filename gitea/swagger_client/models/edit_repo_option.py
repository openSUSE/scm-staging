...
class EditRepoOption(BaseModel):
    ...
    allow_manual_merge: Optional[StrictBool] = Field(
        None,
        description="either `true` to allow mark pr as merged manually, or `false` to prevent it.",
    )
    allow_merge_commits: Optional[StrictBool] = Field(
        None,
        description="either `true` to allow merging pull requests with a merge commit, or `false` to prevent merging pull requests with merge commits.",
    )
    allow_rebase: Optional[StrictBool] = Field(
        None,
        description="either `true` to allow rebase-merging pull requests, or `false` to prevent rebase-merging.",
    )
    allow_rebase_explicit: Optional[StrictBool] = Field(
        None,
    ...
    autodetect_manual_merge: Optional[StrictBool] = Field(
        None,
    ...
    default_allow_maintainer_edit: Optional[StrictBool] = Field(
    ...
    default_delete_branch_after_merge: Optional[StrictBool] = Field(
        None, description="set to `true` to delete pr branch after merge by default"
    )
    default_merge_style: Optional[StrictStr] = Field(
        None,
    ...
    enable_prune: Optional[StrictBool] = Field(
    ...
    has_issues: Optional[StrictBool] = Field(
        None,
        description="either `true` to enable issues for this repository or `false` to disable them.",
    )
    has_projects: Optional[StrictBool] = Field(
        None,
        description="either `true` to enable project unit, or `false` to disable them.",
    )
    has_pull_requests: Optional[StrictBool] = Field(
        None,
        description="either `true` to allow pull requests, or `false` to prevent pull request.",
    )
    has_wiki: Optional[StrictBool] = Field(
        None,
        description="either `true` to enable the wiki for this repository or `false` to disable it.",
    )
    ignore_whitespace_conflicts: Optional[StrictBool] = Field(
        None,
    ...
    mirror_interval: Optional[StrictStr] = Field(
        None,
    ...
    private: Optional[StrictBool] = Field(
        None,
        description="either `true` to make the repository private or `false` to make it public. Note: you will get a 422 error if the organization restricts changing repository visibility to organization owners and a non-owner tries to change the value of private.",
    )
        ...
        _obj = EditRepoOption.parse_obj(
            {
                ...
                "default_allow_maintainer_edit": obj.get(
                    "default_allow_maintainer_edit"
                ),
                "default_branch": obj.get("default_branch"),
                "default_delete_branch_after_merge": obj.get(
                    "default_delete_branch_after_merge"
                ),
                "default_merge_style": obj.get("default_merge_style"),
                "description": obj.get("description"),
                "enable_prune": obj.get("enable_prune"),
                "external_tracker": ExternalTracker.from_dict(
                    obj.get("external_tracker")
                )
                if obj.get("external_tracker") is not None
                else None,
                "external_wiki": ExternalWiki.from_dict(obj.get("external_wiki"))
                if obj.get("external_wiki") is not None
                else None,
                ...
                "internal_tracker": InternalTracker.from_dict(
                    obj.get("internal_tracker")
                )
                if obj.get("internal_tracker") is not None
                else None,
