...
class Issue(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> Issue:
        ...
        _obj = Issue.parse_obj(
            {
                "assets": [Attachment.from_dict(_item) for _item in obj.get("assets")]
                if obj.get("assets") is not None
                else None,
                "assignee": User.from_dict(obj.get("assignee"))
                if obj.get("assignee") is not None
                else None,
                "assignees": [User.from_dict(_item) for _item in obj.get("assignees")]
                if obj.get("assignees") is not None
                else None,
                "body": obj.get("body"),
                ...
                "pull_request": PullRequestMeta.from_dict(obj.get("pull_request"))
                if obj.get("pull_request") is not None
                else None,
                "ref": obj.get("ref"),
                "repository": RepositoryMeta.from_dict(obj.get("repository"))
