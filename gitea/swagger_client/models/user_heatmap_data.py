...
class UserHeatmapData(object):
    ...
    """
    swagger_types = {"contributions": "int", "timestamp": "TimeStamp"}

    attribute_map = {"contributions": "contributions", "timestamp": "timestamp"}

    def __init__(
        self, contributions=None, timestamp=None, _configuration=None
    ):  # noqa: E501
