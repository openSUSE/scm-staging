...
class ExternalTracker(BaseModel):
    ...
    external_tracker_format: Optional[StrictStr] = Field(
        None,
        ...
        _obj = ExternalTracker.parse_obj(
            {
                ...
                "external_tracker_regexp_pattern": obj.get(
                    "external_tracker_regexp_pattern"
                ),
