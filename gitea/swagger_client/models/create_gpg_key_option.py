...
class CreateGPGKeyOption(object):
    ...
    """
    swagger_types = {"armored_public_key": "str", "armored_signature": "str"}
    ...
    def __init__(
        self, armored_public_key=None, armored_signature=None, _configuration=None
    ):  # noqa: E501
    ...
    def armored_public_key(self, armored_public_key):
        ...
        if self._configuration.client_side_validation and armored_public_key is None:
            raise ValueError(
                "Invalid value for `armored_public_key`, must not be `None`"
            )  # noqa: E501
