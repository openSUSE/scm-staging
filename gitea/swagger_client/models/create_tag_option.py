...
class CreateTagOption(object):
    ...
    """
    swagger_types = {"message": "str", "tag_name": "str", "target": "str"}

    attribute_map = {"message": "message", "tag_name": "tag_name", "target": "target"}

    def __init__(
        self, message=None, tag_name=None, target=None, _configuration=None
    ):  # noqa: E501
