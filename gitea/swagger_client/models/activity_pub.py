...
class ActivityPub(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivityPub:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivityPub:
        """Create an instance of ActivityPub from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivityPub.parse_obj(obj)

        _obj = ActivityPub.parse_obj({"context": obj.get("@context")})
        return _obj
