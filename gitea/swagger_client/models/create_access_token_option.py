...
class CreateAccessTokenOption(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateAccessTokenOption:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateAccessTokenOption:
        ...
        _obj = CreateAccessTokenOption.parse_obj({"name": obj.get("name")})
        return _obj
