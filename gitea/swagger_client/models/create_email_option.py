...
class CreateEmailOption(BaseModel):
    ...
    emails: Optional[conlist(StrictStr)] = Field(
        None, description="email addresses to add"
    )
    __properties = ["emails"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateEmailOption:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateEmailOption:
