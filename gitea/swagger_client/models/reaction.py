...
class Reaction(object):
    ...
    """
    swagger_types = {"content": "str", "created_at": "datetime", "user": "User"}

    attribute_map = {"content": "content", "created_at": "created_at", "user": "user"}

    def __init__(
        self, content=None, created_at=None, user=None, _configuration=None
    ):  # noqa: E501
