...
class ServerVersion(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerVersion:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServerVersion:
        """Create an instance of ServerVersion from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ServerVersion.parse_obj(obj)

        _obj = ServerVersion.parse_obj({"version": obj.get("version")})
        return _obj
