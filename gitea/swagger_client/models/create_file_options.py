...
class CreateFileOptions(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateFileOptions:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateFileOptions:
        """Create an instance of CreateFileOptions from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CreateFileOptions.parse_obj(obj)

        _obj = CreateFileOptions.parse_obj(
            {
