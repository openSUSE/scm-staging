...
class AddCollaboratorOption(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddCollaboratorOption:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddCollaboratorOption:
        """Create an instance of AddCollaboratorOption from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AddCollaboratorOption.parse_obj(obj)

        _obj = AddCollaboratorOption.parse_obj({"permission": obj.get("permission")})
        return _obj
