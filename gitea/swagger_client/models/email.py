...
class Email(object):
    ...
    """
    swagger_types = {"email": "str", "primary": "bool", "verified": "bool"}

    attribute_map = {"email": "email", "primary": "primary", "verified": "verified"}

    def __init__(
        self, email=None, primary=None, verified=None, _configuration=None
    ):  # noqa: E501
