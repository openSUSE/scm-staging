...
class CreateForkOption(BaseModel):
    ...
    __properties = ["name", "organization"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateForkOption:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateForkOption:
        """Create an instance of CreateForkOption from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CreateForkOption.parse_obj(obj)

        _obj = CreateForkOption.parse_obj(
            {"name": obj.get("name"), "organization": obj.get("organization")}
        )
        return _obj
