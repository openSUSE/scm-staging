...
class CommitDateOptions(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CommitDateOptions:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CommitDateOptions:
        """Create an instance of CommitDateOptions from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CommitDateOptions.parse_obj(obj)

        _obj = CommitDateOptions.parse_obj(
            {"author": obj.get("author"), "committer": obj.get("committer")}
        )
        return _obj
