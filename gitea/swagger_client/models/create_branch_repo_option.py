...
class CreateBranchRepoOption(object):
    ...
    """
    swagger_types = {"new_branch_name": "str", "old_branch_name": "str"}
    ...
    def __init__(
        self, new_branch_name=None, old_branch_name=None, _configuration=None
    ):  # noqa: E501
    ...
    def new_branch_name(self, new_branch_name):
        ...
        if self._configuration.client_side_validation and new_branch_name is None:
            raise ValueError(
                "Invalid value for `new_branch_name`, must not be `None`"
            )  # noqa: E501
