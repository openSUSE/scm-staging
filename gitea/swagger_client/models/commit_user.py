...
class CommitUser(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CommitUser:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CommitUser:
        """Create an instance of CommitUser from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CommitUser.parse_obj(obj)

        _obj = CommitUser.parse_obj(
            {
