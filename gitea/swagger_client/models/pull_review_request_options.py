...
class PullReviewRequestOptions(object):
    ...
    """
    swagger_types = {"reviewers": "list[str]", "team_reviewers": "list[str]"}

    attribute_map = {"reviewers": "reviewers", "team_reviewers": "team_reviewers"}

    def __init__(
        self, reviewers=None, team_reviewers=None, _configuration=None
    ):  # noqa: E501
