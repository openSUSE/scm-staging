...
class GitHook(object):
    ...
    """
    swagger_types = {"content": "str", "is_active": "bool", "name": "str"}

    attribute_map = {"content": "content", "is_active": "is_active", "name": "name"}

    def __init__(
        self, content=None, is_active=None, name=None, _configuration=None
    ):  # noqa: E501
