...
class TopicName(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TopicName:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TopicName:
        """Create an instance of TopicName from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return TopicName.parse_obj(obj)

        _obj = TopicName.parse_obj({"topics": obj.get("topics")})
        return _obj
