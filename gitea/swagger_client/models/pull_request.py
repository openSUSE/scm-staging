        ...
        _obj = PullRequest.parse_obj(
            {
                ...
                "base": PRBranchInfo.from_dict(obj.get("base"))
                ...
                "head": PRBranchInfo.from_dict(obj.get("head"))
                ...
                "merged_by": User.from_dict(obj.get("merged_by"))
                if obj.get("merged_by") is not None
                else None,
