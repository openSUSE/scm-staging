...
class Commit(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> Commit:
        ...
        _obj = Commit.parse_obj(
            {
                "author": User.from_dict(obj.get("author"))
                if obj.get("author") is not None
                else None,
                "commit": RepoCommit.from_dict(obj.get("commit"))
                if obj.get("commit") is not None
                else None,
                "committer": User.from_dict(obj.get("committer"))
                if obj.get("committer") is not None
                else None,
                "created": obj.get("created"),
                "files": [
                    CommitAffectedFiles.from_dict(_item) for _item in obj.get("files")
                ]
                if obj.get("files") is not None
                else None,
                "html_url": obj.get("html_url"),
                "parents": [CommitMeta.from_dict(_item) for _item in obj.get("parents")]
                if obj.get("parents") is not None
                else None,
                "sha": obj.get("sha"),
                "stats": CommitStats.from_dict(obj.get("stats"))
