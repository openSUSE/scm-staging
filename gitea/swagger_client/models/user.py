...
class User(BaseModel):
    ...
    avatar_url: Optional[StrictStr] = Field(
        None, description="URL to the user's avatar"
    )
    ...
    is_admin: Optional[StrictBool] = Field(
        None, description="Is the user an administrator"
    )
    ...
    login_name: Optional[StrictStr] = Field(
        "empty", description="the user's authentication sign-in name."
    )
    prohibit_login: Optional[StrictBool] = Field(
        None, description="Is user login prohibited"
    )
        ...
        _obj = User.parse_obj(
            {
                ...
                if obj.get("login_name") is not None
                else "empty",
