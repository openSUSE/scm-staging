...
class FileLinksResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FileLinksResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FileLinksResponse:
        """Create an instance of FileLinksResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return FileLinksResponse.parse_obj(obj)

        _obj = FileLinksResponse.parse_obj(
            {
                "git": obj.get("git"),
                "html": obj.get("html"),
