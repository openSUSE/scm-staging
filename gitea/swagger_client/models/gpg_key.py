        ...
        _obj = GPGKey.parse_obj(
            {
                ...
                "emails": [GPGKeyEmail.from_dict(_item) for _item in obj.get("emails")]
                ...
                "subkeys": [GPGKey.from_dict(_item) for _item in obj.get("subkeys")]
                if obj.get("subkeys") is not None
                else None,
