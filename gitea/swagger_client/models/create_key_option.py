...
class CreateKeyOption(object):
    ...
    """
    swagger_types = {"key": "str", "read_only": "bool", "title": "str"}

    attribute_map = {"key": "key", "read_only": "read_only", "title": "title"}

    def __init__(
        self, key=None, read_only=None, title=None, _configuration=None
    ):  # noqa: E501
