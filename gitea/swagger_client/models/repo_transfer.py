...
class RepoTransfer(object):
    ...
    """
    swagger_types = {"doer": "User", "recipient": "User", "teams": "list[Team]"}

    attribute_map = {"doer": "doer", "recipient": "recipient", "teams": "teams"}

    def __init__(
        self, doer=None, recipient=None, teams=None, _configuration=None
    ):  # noqa: E501
