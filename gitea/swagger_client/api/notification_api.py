...
class NotificationApi(object):
    ...
    async def notify_get_list(
        ...
        subject_type: Annotated[
            Optional[conlist(StrictStr)],
            Field(description="filter notifications by subject type"),
        ] = None,
        since: Annotated[
            Optional[datetime],
            Field(
    ...
    def notify_get_list(
        ...
        **kwargs
        ...
        List[NotificationThread], Awaitable[List[NotificationThread]]
    ]:  # noqa: E501
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the notify_get_list_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        if async_req is not None:
            kwargs["async_req"] = async_req
        return self.notify_get_list_with_http_info(
            all, status_types, subject_type, since, before, page, limit, **kwargs
        )  # noqa: E501
    ...
    def notify_get_repo_list(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the notify_get_repo_list_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        if async_req is not None:
            kwargs["async_req"] = async_req
        return self.notify_get_repo_list_with_http_info(
            owner,
            repo,
            all,
            status_types,
    ...
    def notify_get_thread(
        ...
        async_req: Optional[bool] = None,
        **kwargs
    ) -> Union[NotificationThread, Awaitable[NotificationThread]]:  # noqa: E501
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the notify_get_thread_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        if async_req is not None:
            kwargs["async_req"] = async_req
    ...
    ) -> NotificationCount:  # noqa: E501
        ...

    @validate_arguments
    def notify_new_available(
        self, async_req: Optional[bool] = None, **kwargs
    ) -> Union[NotificationCount, Awaitable[NotificationCount]]:  # noqa: E501
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the notify_new_available_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        if async_req is not None:
            kwargs["async_req"] = async_req
    ...
    async def notify_read_list(
        ...
        to_status: Annotated[
            Optional[StrictStr],
            Field(description="Status to mark notifications as, Defaults to read."),
        ] = None,
        **kwargs
    ) -> List[NotificationThread]:  # noqa: E501
        ...
    ...
    def notify_read_list(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the notify_read_list_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        if async_req is not None:
            kwargs["async_req"] = async_req
        return self.notify_read_list_with_http_info(
            last_read_at, all, status_types, to_status, **kwargs
        )  # noqa: E501
    ...
    def notify_read_list_with_http_info(
        ...
        **kwargs
        ...
        _all_params = ["last_read_at", "all", "status_types", "to_status"]
        _all_params.extend(
            [
                "async_req",
                "_return_http_data_only",
    ...
    def notify_read_repo_list(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the notify_read_repo_list_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        if async_req is not None:
            kwargs["async_req"] = async_req
        return self.notify_read_repo_list_with_http_info(
            owner, repo, all, status_types, to_status, last_read_at, **kwargs
        )  # noqa: E501
    ...
    async def notify_read_thread(
        ...
        id: Annotated[StrictStr, Field(..., description="id of notification thread")],
        to_status: Annotated[
            Optional[StrictStr], Field(description="Status to mark notifications as")
        ] = None,
        **kwargs
    ) -> NotificationThread:  # noqa: E501
        ...
    ...
    def notify_read_thread(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the notify_read_thread_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        if async_req is not None:
            kwargs["async_req"] = async_req
        return self.notify_read_thread_with_http_info(
            id, to_status, **kwargs
        )  # noqa: E501
