...
class MiscellaneousApi(object):
    ...
    def get_node_info(
    ...
    ) -> Union[NodeInfo, Awaitable[NodeInfo]]:  # noqa: E501
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the get_node_info_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
    ...
    def get_signing_key(
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the get_signing_key_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        if async_req is not None:
            kwargs["async_req"] = async_req
    ...
    def get_version(
        self, async_req: Optional[bool] = True, **kwargs
    ) -> ServerVersion:  # noqa: E501
        ...

    @validate_arguments
    def get_version(
        self, async_req: Optional[bool] = None, **kwargs
    ) -> Union[ServerVersion, Awaitable[ServerVersion]]:  # noqa: E501
    ...
    async def render_markdown(
        self, body: Optional[MarkdownOption] = None, **kwargs
    ) -> str:  # noqa: E501
        ...
    ...
    def render_markdown(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the render_markdown_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        if async_req is not None:
            kwargs["async_req"] = async_req
    ...
    def render_markdown_raw(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the render_markdown_raw_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        if async_req is not None:
            kwargs["async_req"] = async_req
    ...
    def render_markdown_raw_with_http_info(
        ...
        **kwargs
        ...
        # set the HTTP header `Content-Type`
        _content_types_list = _params.get(
            "_content_type", self.api_client.select_header_content_type(["text/plain"])
        )
        if _content_types_list:
            _header_params["Content-Type"] = _content_types_list
